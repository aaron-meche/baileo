...
shuffle(Object.keys(media_info));
const Media_Item_svelte_svelte_type_style_lang = "";
const css$1 = {
  code: ".item.svelte-9h5e74{width:180pt;padding:10pt;cursor:default;border-radius:5pt;background:rgb(25, 25, 25, 0);box-shadow:inset 0 0 0 0 var(--accent);transition:background 100ms;display:inline-block}.item.svelte-9h5e74:hover{background:var(--hover-bg);box-shadow:inset 0 -1pt 0 0 var(--accent)}img.svelte-9h5e74{width:100%;border-radius:inherit}.title.svelte-9h5e74{font-weight:500}.type.svelte-9h5e74{color:gray;font-weight:300}",
  map: null
};
const Mediau20Item = create_ssr_component(($$result, $$props, $$bindings, slots) => {
...
<div class="${"item svelte-9h5e74"}"><img${add_attribute("src", imgUrl, 0)} alt="${"Media Thumbnail"}" class="${"svelte-9h5e74"}">
    <div class="${"information"}"><div class="${"title svelte-9h5e74"}">${escape(title)}</div>
        <div class="${"type svelte-9h5e74"}">${escape(type)}</div></div></div>

`;
});
const _page_svelte_svelte_type_style_lang = "";
const css = {
  code: "button.svelte-rvgfry{all:unset}section.svelte-rvgfry{padding:20pt 0}.section-title.svelte-rvgfry{font-size:15pt;padding:15pt}.horizontal-scroll.svelte-rvgfry{overflow-x:scroll;overflow-y:hidden;white-space:nowrap;padding:0 10pt}.horizontal-scroll.svelte-rvgfry::-webkit-scrollbar{display:none}",
  map: null
};
...
${$$result.head += `<!-- HEAD_svelte-1anpopb_START -->${$$result.title = `<title>Home</title>`, ""}<!-- HEAD_svelte-1anpopb_END -->`, ""}



<section class="${"svelte-rvgfry"}"><div class="${"section-title svelte-rvgfry"}">Comedies</div>
	<div class="${"horizontal-scroll section svelte-rvgfry"}">${each(listOf_mediaTitles, (elem) => {
    return `${media_info[elem]["cat"] == "comedy" ? `<button class="${"svelte-rvgfry"}">${validate_component(Mediau20Item, "MediaItem").$$render(
      $$result,
      {
        title: elem,
        type: media_info[elem]["mediaType"]
      },
      {},
      {}
    )}
...
<section class="${"svelte-rvgfry"}"><div class="${"section-title svelte-rvgfry"}">Dramas</div>
	<div class="${"horizontal-scroll section svelte-rvgfry"}">${each(listOf_mediaTitles, (elem) => {
    return `${media_info[elem]["cat"] == "drama" ? `<button class="${"svelte-rvgfry"}">${validate_component(Mediau20Item, "MediaItem").$$render(
      $$result,
      {
        title: elem,
        type: media_info[elem]["mediaType"]
...
<section class="${"svelte-rvgfry"}"><div class="${"section-title svelte-rvgfry"}">Animations</div>
	<div class="${"horizontal-scroll section svelte-rvgfry"}">${each(listOf_mediaTitles, (elem) => {
    return `${media_info[elem]["cat"] == "animation" ? `<button class="${"svelte-rvgfry"}">${validate_component(Mediau20Item, "MediaItem").$$render(
      $$result,
      {
        title: elem,
        type: media_info[elem]["mediaType"]
...
<section class="${"svelte-rvgfry"}"><div class="${"section-title svelte-rvgfry"}">TV Shows</div>
	<div class="${"horizontal-scroll section svelte-rvgfry"}">${each(listOf_mediaTitles, (elem) => {
    return `${media_info[elem]["mediaType"] == "TV Show" ? `<button class="${"svelte-rvgfry"}">${validate_component(Mediau20Item, "MediaItem").$$render(
      $$result,
      {
        title: elem,
        type: media_info[elem]["mediaType"]
...
<section class="${"svelte-rvgfry"}"><div class="${"section-title svelte-rvgfry"}">Movies</div>
	<div class="${"horizontal-scroll section svelte-rvgfry"}">${each(listOf_mediaTitles, (elem) => {
    return `${media_info[elem]["mediaType"] == "Movie" ? `<button class="${"svelte-rvgfry"}">${validate_component(Mediau20Item, "MediaItem").$$render(
      $$result,
      {
        title: elem,
        type: media_info[elem]["mediaType"]
