const storage = {
  ...
  confirm: function(location, value, callback) {
    if (localStorage[location] == value)
      callback();
    else
      alert("storage.confirm[val] error... reset ∞ loop detected");
  },
...
function serverTypeConversion(string) {
